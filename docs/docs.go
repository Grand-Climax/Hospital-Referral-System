...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/auth/login": {
            "post": {
                "description": "Authenticate with email and password as step 1 of MFA.\nReturns a short-lived intermediate token (` + "`" + `mfa_token` + "`" + `) that is only valid for MFA setup/verification flows.\nIf ` + "`" + `mfa_setup_required=true` + "`" + `, client must call MFA setup first, then verify.\n**Roles:** Any user with an active account.\n**Common Errors:**\n- 401 (Invalid Credentials)\n- 401 (Account Inactive)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "Intermediate MFA token response",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.MFAResetRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/mfa/setup": {
            "post": {
                ...
                "description": "Initialize MFA for the current user when no MFA secret exists yet.\nGenerates and persists a TOTP secret, then returns an ` + "`" + `otpauth://` + "`" + ` URI for QR generation.\nAccepts either a full access token or the intermediate MFA token from login.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/v1/auth/mfa/verify": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Full authentication token pair",
                        "schema": {
